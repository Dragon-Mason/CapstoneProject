    ...
    for j in range(37):
        ...
        for x in range(112):
            ...
            for y in range(150):
                ...
                temperature = min([TMP_values[2*x][2*y], TMP_values[2*x+1][2*y], TMP_values[2*x][2*y+1], TMP_values[2*x+1][2*y+1]])  # V10
                relative_humidity = max([RH_values[2*x][2*y], RH_values[2*x+1][2*y], RH_values[2*x][2*y+1], RH_values[2*x+1][2*y+1]]) # V11
