...
urlretrieve(url, 'rap_252_20201101_0000_000.grb2')
grbs = pygrib.open('rap_252_20201101_0000_000.grb2')
...
# Temperature [K]
TMP_grb10000 = grbs.select(name='Temperature')[36] # The first message of 'temperature'. Pressure level = 10000 Pa
