...
- Contrail-Cirrus Clouds are estimated to contribute 2% of the Earth‘s total anthropogenic global warming. 
...
- The following graphs show the ceiling and floor for each DateTime and the AVG ceiling and floor by day/month. 
- Looking at the overall trend, we could find the concentration of the ceiling and floor from 15000 to 50000.
- According to the monthly AVG volume of ISSR, August is the lowest point, with an upward trend as the winter enters. So, when mapped to the monthly AVG ceiling and floor, the distance between the two lines in August is the closest. After the fall, the distance between the two gap is increasing.
...
# 5. Volume of ISSRs at different pressure levels {.tabset}
...
- According to the monthly data at each pressure level, with a cut-off point of 25,000Pa, the Volume of ISSR is mainly formed in summer in high altitude areas (low pressure), while formed in winter in low altitude areas (high pressure).
